    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex justify-between items-start">
        <div className="space-y-2">
          <h1 className="text-2xl font-bold text-white">Dashboard Compliance</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Client Non-Conformity Management Card */}
          ...
          <CardContent className="p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="text-center">
                <div className="text-3xl font-bold text-white mb-1">{clientStats.todas}</div>
                <div className="text-sm text-gray-300">Todas</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-blue-400 mb-1">{clientStats.novas}</div>
                <div className="text-sm text-gray-300">Novas</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-yellow-400 mb-1">{clientStats.emCurso}</div>
                <div className="text-sm text-gray-300">Em curso</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-green-400 mb-1">{clientStats.resolvidas}</div>
                <div className="text-sm text-gray-300">Resolvidas</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-red-400 mb-1">{clientStats.pendentes}</div>
                <div className="text-sm text-gray-300">Pendentes</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-green-500 mb-1">{clientStats.eficazes}</div>
                <div className="text-sm text-gray-300">Eficazes</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-red-500 mb-1">{clientStats.semEficacia}</div>
        ...
        {/* Supplier Non-Conformity Management Card */}
        <Card className="card-glass relative overflow-hidden">
          ...
          <CardContent className="p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="text-center">
                <div className="text-3xl font-bold text-white mb-1">{supplierStats.todas}</div>
                <div className="text-sm text-gray-300">Todas</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-blue-400 mb-1">{supplierStats.novas}</div>
                <div className="text-sm text-gray-300">Novas</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-yellow-400 mb-1">{supplierStats.emCurso}</div>
                <div className="text-sm text-gray-300">Em curso</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-green-400 mb-1">{supplierStats.resolvidas}</div>
                <div className="text-sm text-gray-300">Resolvidas</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-red-400 mb-1">{supplierStats.pendentes}</div>
                <div className="text-sm text-gray-300">Pendentes</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-green-500 mb-1">{supplierStats.eficazes}</div>
                <div className="text-sm text-gray-300">Eficazes</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-red-500 mb-1">{supplierStats.semEficacia}</div>
                <div className="text-sm text-gray-300">Sem eficácia</div>
              </div>
            </div>
          </CardContent>
